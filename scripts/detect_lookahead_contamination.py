...
class LookaheadDetector:
    ...
    def run_analysis(self) -> bool:
        ...
        try:
            ...
            # Run checks
            temporal_ok = self.check_temporal_integrity(df_fixed)
            feature_issues = self.check_feature_lookahead(df_fixed)
            target_issues = self.check_target_construction(df_fixed)
