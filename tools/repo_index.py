...
class RepoIndexer:
    ...
    def generate_module_map(self, all_files: List[Dict]) -> str:
        ...
        module_map += (
            "Comprehensive map of all Python modules in the Aurora trading system.\n\n"
        )
        ...
        for dir_name in sorted_dirs:
            ...
            for file_info in files:
                module_map += (
                    f"- **{file_info['name']}.py** ({file_info['lines']} lines)\n"
                )
    ...
    def run(self):
        ...
        print("🔍 Aurora Repository Indexer")
        print("=" * 40)
        ...
        for dir_name, files in dirs_with_files.items():
            ...
            if (
                ...
                or "Auto-generated by Aurora Repository Indexer"
