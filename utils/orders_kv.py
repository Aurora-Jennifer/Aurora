...
def generate_client_order_id(symbol: str, run_id: Optional[str] = None) -> str:
...
def put_order(client_order_id: str, broker_order_id: Optional[str] = None, status: str = "NEW") -> None:
...
def update_order_status(client_order_id: str, status: str, broker_order_id: Optional[str] = None) -> None:
