...
def build_features_for_symbol(symbol: str, start_date: str = "2020-01-01", 
...
def build_feature_store(symbols: List[str], output_dir: str = "artifacts/feature_store") -> Dict[str, str]:
    """
