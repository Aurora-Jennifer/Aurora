...
class TradeBook:
    ...
    def on_sell(self, date: str, symbol: str, qty: float, price: float, fees: float, remaining_qty_after_sell: float):
        ...
        self.logger.info(f"SELL: {symbol} {real_qty} @ ${price:.2f}, Realized: ${realized_partial:.2f}")
