...
def setup_logging(log_file: str = "trading.log", level: int = logging.INFO) -> logging.Logger:
    """
...
def calculate_performance_metrics(equity: pd.Series, start_date: str, end_date: str) -> Dict[str, float]:
    """
