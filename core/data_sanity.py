...
class DataSanityValidator:
    ...
    def validate_and_repair(
        ...
        # 2. Validate and repair price data (strict bounds)
        ...
        # 3. Validate and repair OHLC consistency (strict relationships)
        ...
        # 4. Validate and repair volume data (strict non-negative)
        ...
        # 5. Detect and repair outliers (robust detection)
        (
            clean_data,
            outlier_repairs,
            outlier_count,
        ...
        # 6. Calculate clean returns (strict bounds)
