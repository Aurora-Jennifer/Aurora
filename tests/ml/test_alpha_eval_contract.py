...
def test_alpha_eval_metrics_calculation():
    ...
    from ml.eval.alpha_eval import (
        calculate_ic_spearman, calculate_hit_rate, 
        calculate_turnover, calculate_return_with_costs
    )
...
def test_alpha_eval_schema_compliance():
    ...
    try:
        ...
        from ml.trainers.train_linear import load_feature_data as original_load
        ...
        for fold in fold_summaries:
            required_fold_fields = ['fold', 'train_start', 'train_end', 'test_start', 'test_end',
                                  'ic_spearman', 'hit_rate', 'turnover', 'return_with_costs']
...
def test_deterministic_results():
    ...
    try:
        ...
        assert results1['overall_metrics']['mean_hit_rate'] == results2['overall_metrics']['mean_hit_rate']
